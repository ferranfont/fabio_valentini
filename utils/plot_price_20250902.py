"""
Simple Price Chart Plotter - September 2, 2025
...
DATA_FILE = PROJECT_ROOT / "data" / "historic" / "time_and_sales_nq_20250902.csv"
OUTPUT_FILE = PROJECT_ROOT / "charts" / "price_chart_20250902.html"

print("="*80)
print("SIMPLE PRICE CHART PLOTTER - SEPTEMBER 2, 2025")
print("="*80)
...
print(f"[INFO] Trading duration: {hours:.2f} hours")
...
fig.update_layout(
    title=dict(
        text=f'NQ Price Chart - September 2, 2025<br><sub>{len(df):,} ticks | Duration: {hours:.1f} hours</sub>',
        x=0.5,
        xanchor='center',
